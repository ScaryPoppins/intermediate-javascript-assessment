...
String.prototype.grammarPolice = function(){
  ...
  for(var donglesIndex = 0; donglesIndex < newString.length; donglesIndex++){
    newString[donglesIndex] = newString[donglesIndex].charAt(0).toUpperCase() + newString[donglesIndex].substring(1)
  }
